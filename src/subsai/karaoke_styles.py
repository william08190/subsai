...
class KaraokeStyle:
    ...
    def __init__(self, style_id: int, name: str, description: str):
...
class ClassicStyle(KaraokeStyle):
    ...
    def get_ass_style_line(self) -> str:
        ...
        # Alignment: 2 = 底部居中
        return "Style: Classic,Microsoft YaHei,48,&H00FFFFFF,&H0000FFFF,&H00000000,&H80000000,-1,0,0,0,100,100,0,0,1,3,2,2,30,30,120,1"
...
class ModernStyle(KaraokeStyle):
    ...
    def get_ass_style_line(self) -> str:
        ...
        # Alignment: 8 = 顶部居中
        return "Style: Modern,Microsoft YaHei,52,&H00FFFFFF,&H00FF8C00,&H00000000,&H80000000,-1,0,0,0,100,100,2,0,1,2,1,8,30,30,30,1"
...
class NeonStyle(KaraokeStyle):
    ...
    def get_ass_style_line(self) -> str:
        ...
        # Alignment: 5 = 中部居中
        return "Style: Neon,Microsoft YaHei,50,&H00FFFFFF,&H00FF00FF,&H00FF00FF,&H80FF00FF,-1,0,0,0,100,100,1,0,1,4,4,5,30,30,80,1"
...
class ElegantStyle(KaraokeStyle):
    ...
    def get_ass_style_line(self) -> str:
        ...
        # ScaleX: 105 (稍微拉宽)
        # Alignment: 2 = 底部居中
        return "Style: Elegant,Microsoft YaHei,46,&H00FFFFFF,&H00FFD700,&H00000000,&H80000000,-1,0,0,0,105,100,1,0,1,2,2,2,30,30,100,1"
...
class AnimeStyle(KaraokeStyle):
    ...
    def get_ass_style_line(self) -> str:
        ...
        # Outline: 4 (粗边框)
        # Alignment: 2 = 底部居中
        return "Style: Anime,Microsoft YaHei,44,&H00FFFFFF,&H0000FFFF,&H00000000,&H80000000,-1,0,0,0,100,100,0,0,1,4,3,2,30,30,110,1"
...
def get_style(style_name: str) -> KaraokeStyle:
    """
    获取指定样式实例
...
def get_all_styles() -> Dict[str, KaraokeStyle]:
    """获取所有可用样式"""
    return {name: cls() for name, cls in STYLE_CLASSES.items()}
